...
if (!empty($titel) OR ($url)) {
 $query = mysql_query("INSERT INTO tutorioals (titel, tags, categorie, url, beschrijving, datum, ) VALUES ('$titel','$tags','$categorie','$url','$beschrijving','$datum',')");
 ...
 ?>
<html>
  <a href="toevoegen_tutorials.php"> Terug naar tutorials</a>
</html>