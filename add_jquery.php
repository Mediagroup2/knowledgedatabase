...
if (!empty($titel) OR ($url)) {
 $query = mysqli_query($con, "INSERT INTO jquery (titel, tags, categorie, url, beschrijving, toegevoegd_op) VALUES ('$_POST[titel]','$_POST[tags]','$_POST[categorie]','$_POST[url]','$_POST[beschrijving]','$_POST[toegevoegd_op]')");
  mysql_close();
