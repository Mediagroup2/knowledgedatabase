...
if (!empty($titel) OR ($url)) {
 $query = mysql_query("INSERT INTO links (titel, tags, categorie, url, beschrijving, datum, ) VALUES ('$titel','$tags','$categorie','$url','$beschrijving','$datum',')");
 ...
 ?>
<html>
  <a href="toevoegen_links.php"> Terug naar links</a>
</html>