...
error_reporting(E_ALL ^ E_NOTICE);
 ...
 $toegevoegd_op = mysql_real_escape_string($_POST['toegevoegd_op']);
  $queryEdit = mysql_query("UPDATE php SET titel = '$titel', tags = '$tags', url_video = '$url_video', link = '$link', beschrijving = '$beschrijving', toegevoegd_op = '$toegevoegd_op', WHERE id= '$id'");
  if ($queryEdit) {
           header('location: toevoegen_php.php');

  }
if (!empty($titel) OR ($url)) {
 $query = mysqli_query($con, "INSERT INTO php (titel, tags, url_video, link, beschrijving, toegevoegd_op) VALUES ('$_POST[titel]','$_POST[tags]','$_POST[url_video]','$_POST[link]','$_POST[beschrijving]','$_POST[toegevoegd_op]')");
  mysql_close();
 ...
 ?>
<html>
  <a href="toevoegen_php.php"> Terug naar videos</a>
</html>