...
error_reporting(E_ALL ^ E_NOTICE);
 ...
 $toegevoegd_op = mysql_real_escape_string($_POST['toegevoegd_op']);
  $queryEdit = mysql_query("UPDATE videos SET titel = '$titel', tags = '$tags', categorie = '$categorie', url = '$url', beschrijving = '$beschrijving', toegevoegd_op = '$toegevoegd_op', WHERE id= '$id'");
  if ($queryEdit) {
           header('location: toevoegen_videos.php');
